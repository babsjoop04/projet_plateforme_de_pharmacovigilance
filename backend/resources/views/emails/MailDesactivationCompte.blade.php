...
<head>
  ...
  <![endif]-->
  <title>Mail de desactivation de compte</title>
  <style>
...
<body style="margin: 0; width: 100%; background-color: #f8fafc; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  ...
  <div role="article" aria-roledescription="email" aria-label="Mail de desactivation de compte" lang="en">
              ...
              <tr>
                <td class="sm-px-6" style="border-radius: 4px; background-color: #fffffe; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                  ...
                  <p style="margin: 0; line-height: 24px">
                    Nous vous informons que votre compte sur notre plateforme de pharmacovigilance a été
                    désactivé à partir du [date de désactivation]. Cette désactivation peut avoir été
                    effectuée pour l’une des raisons suivantes : </p>
                  <ul>
                    <li>Une inactivité prolongée sur la plateforme.
                    </li>
                    <li>Une non-conformité aux conditions d’utilisation.
                    </li>
                  </ul>
                  <p></p>
                  <div role="separator" style="line-height: 10px">&zwj;</div>
                  <p style="margin: 0; line-height: 24px;">
                    Si vous souhaitez réactiver votre compte ou obtenir plus de détails sur cette
                    désactivation, nous vous invitons à nous contacter à admin@samapharmacovigile.sn. Notre
                    équipe se tient à votre disposition pour répondre à vos questions ou vous guider
                    dans les étapes à suivre. </p>
                  <div role="separator" style="line-height: 10px">&zwj;</div> Nous vous remercions pour votre compréhension et espérons pouvoir vous accueillir à
