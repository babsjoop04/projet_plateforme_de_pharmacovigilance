...
<head>
  ...
  <![endif]-->
  <title>Mail d'information de notification</title>
  <style>
...
<body style="margin: 0; width: 100%; background-color: #f8fafc; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  ...
  <div role="article" aria-roledescription="email" aria-label="Mail d'information de notification" lang="en">
              ...
              <tr>
                <td class="sm-px-6" style="border-radius: 4px; background-color: #fffffe; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                  ...
                  <p style="margin: 0; line-height: 24px">
                    Nous vous confirmons la réception de votre notification concernant ce(s) produit(s) de santé
                  </p>
                  ...
                  <p style="margin: 0; line-height: 24px;">
                    Notre équipe examine actuellement votre signalement avec la plus grande
                    attention. Nous vous contacterons dans un délai de 5 à 10 jours ouvrés si nous avons besoin
                    d'informations complémentaires.
                  </p>
                  <div role="separator" style="line-height: 10px">&zwj;</div> <span class="sm-leading-8" style="margin: 0 0 24px; font-size: 16px; font-weight: 600; color: #000001">
                  Informations Importantes
                </span> <span style="margin: 0; line-height: 24px;">
                <ul>
                  <li>
                    Conservez votre numéro de référence pour tout suivi ultérieur</li>
                  <li>
                    Toutes les informations sont traitées de manière strictement confidentielle</li>
                  <li>
                    Votre contribution est essentielle à la sécurité des patients</li>
                </ul>
                </span>
                  <div role="separator" style="line-height: 10px">&zwj;</div>
